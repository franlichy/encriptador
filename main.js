import { encrypt, decrypt } from "./utils/encriptar.js"

// Localizo elementos principales
const input = document.getElementById("inputMain")
const result = document.getElementById("result")

const botonEncriptar = document.getElementById("encryptBtn")
...
<img src="img/defaultResultImg.svg" alt="default result" class="resultImgDefault" />
...
botonEncriptar.onclick = encryptSubmit
